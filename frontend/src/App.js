...
function App() {
    ...
    // Handler to receive areaName from LocationStats
    const handleAreaName = (area) => {
      if (area && typeof area === 'string') setLocationString(area);
    };
      ...
      <div className="min-h-screen flex bg-gradient-to-br from-primary-50 to-primary-100">
        ...
        <main className="flex-1 flex flex-col items-center justify-start py-8 px-2 md:px-8 overflow-hidden">
          ...
          <div className="w-full max-w-3xl">
            <ChatBot locationString={locationString} />
          </div>
        </main>
      </div>
    );
